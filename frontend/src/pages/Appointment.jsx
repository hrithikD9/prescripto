  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // increment currentTime  by 30 mins
  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='py-3 px-14 my-6 border rounded-full bg-primary text-white font-light text-sm'>Book an Appointment</button>
      </div>
